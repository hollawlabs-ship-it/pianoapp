  ...
  function sttSection() {
    ...
    return el('div', {}, [
      ...
      el('p', { class: 'tiny faint', style: { lineHeight: '1.7' }, text:
        'console.groq.com에서 무료로 발급합니다. 하루 8시간 분량까지 무료라 주 6시간(1시간 2회 + 2시간 2회)은 한도에 닿지 않습니다. ' +
        '파일 하나는 25MB까지 — 앱 녹음은 24kbps라 두 시간이 약 21MB로 들어옵니다. ' +
        '밖에서 찍은 파일은 비트레이트가 높아 한도를 넘을 수 있고, 그때는 클로바노트로 전사하세요.' }),
    ]);
  }
